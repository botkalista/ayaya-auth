...
function init(config) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new mongodb_1.MongoClient(config.connectionString).connect()];
                case 1:
                    client = _a.sent();
                    usersCollection = client.db(config.dbName).collection(config.userCollection);
                    userRepo = new UserRepo_1.UserRepository(usersCollection, config);
                    return [2 /*return*/];
            }
        });
    });
...
exports.authMiddleware = UserRouter_1.needAuthentication;
